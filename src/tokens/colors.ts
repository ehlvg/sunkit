...
export const COLOR_MAP: Record<ButtonColor, { hex: string; darkHex: string }> =
  Object.fromEntries(COLORS.map(c => [c.id, { hex: c.hex, darkHex: c.darkHex }])) as Record<
    ButtonColor,
    { hex: string; darkHex: string }
  >
