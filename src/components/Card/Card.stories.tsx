...
export const Default: Story = {
  render: (args) => (
    <Card {...args} style={{ maxWidth: 360 }}>
      <Card.Header>
        <h3 style={{ margin: 0, fontSize: 14, fontWeight: 600, color: 'rgba(0,0,0,0.75)' }}>
          Card title
        </h3>
      ...
      <Card.Body>
        <p style={{ margin: 0, fontSize: 13, color: 'rgba(0,0,0,0.65)', lineHeight: 1.6 }}>
          This is the body content. Cards are great for grouping related information in a clean
          container.
        </p>
      </Card.Body>
      <Card.Footer>
